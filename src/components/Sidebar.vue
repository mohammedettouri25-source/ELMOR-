...
<template>
  ...
  <aside class="sidebar" :class="{ 'sidebar-open': sidebarOpen }">
    ...
    <div style="margin-bottom: 20px; padding: 0 4px;">
      <button class="btn-primary" style="width: 100%; justify-content: space-between; padding: 10px 14px; font-size: 12px; background: #0071e3; border-color: #0071e3; border-radius: 12px;" @click="navigate('landing')">
        <span style="display: flex; align-items: center; gap: 8px;">
          <Globe :size="16" /> Boutique Client
        </span>
    ...
    <div style="margin-top: auto; padding-top: 16px; border-top: 1px solid var(--border-color);">
      <div style="display: flex; align-items: center; gap: 10px; padding: 8px;">
        <div style="width: 36px; height: 36px; border-radius: 50%; background: #09090b; color: #fff; font-weight: 800; display: grid; place-items: center; font-size: 12px; flex-shrink: 0;">
          AD
        </div>
        <div>
